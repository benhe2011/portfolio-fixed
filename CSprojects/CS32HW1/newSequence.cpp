...
Sequence::Sequence(int n) {
	...
	m_sequence = new ItemType[n];
	m_items = 0;
	max_size = n;
}

Sequence::Sequence(const Sequence& other)
	: m_items(other.m_items), max_size(other.max_size){
	m_sequence = new ItemType[other.max_size];
...
void Sequence::swap(Sequence& other) {
	...
	ItemType* temp1 = m_sequence;
	m_sequence = other.m_sequence;
	other.m_sequence = temp1;
